...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'All Payment Method List')
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex">
                        <h5 class="p-2 mb-0 mr-auto box-title">Payment Method</h5>
                        <button type="button" class="btn btn-primary btn-sm DataAddButton">Add Payment Method</button>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal fade" id="DataAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <form id="DataAddUpdate" action="{{ route('admin.payment_method.insert') }}" method="post"
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.DataAddButton', function() {
                ...
                $('.modal-title').text('Add Payment Method'); // text will change
                $("#DataAdd").modal('show');
            });
            ...
            $('#dt-scroll-horizonal').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{{ route('admin.payment_method.data') }}", // URL will change
                    type: 'GET',
                    cache: false,
                    data: function(d) {}
                },
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $(this).ajaxSubmit({
                            ...
                            method: 'POST',
                            dataType: 'json',
                            url: "{{ route('admin.payment_method.insert') }}" // URL will change
                                ,
            ...
            $(document).on('click', '.tableEdit', function() {
                let Id = $(this).data('id');
                $('.modal-title').text('Update Payment Method'); // text will change
                ...
                $(this).ajaxSubmit({
                    ...
                    dataType: 'json',
                    method: 'GET',
                    url: "{{ route('admin.payment_method.edit') }}" // URL will change
                        ,
                    success: function(responseText) {
