...
<head>
    ...
    <title>@yield('title', 'Destination 2 Dream')</title>
    <meta name="description" content="@yield('description', 'We will help you on university admission, scholarships and visa processing to achieve your goal.')">
